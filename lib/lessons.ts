...
const RAW: [string, string][] = [
  ...
  // Added after every written lesson, so no existing number shifts.
  ['Your childhood card made you good at this', '6 min'],
  ['What got decided before you had a say', '6 min'],
  ["Your parents' marriage card, read into yours", '7 min'],
  ['Same-suit siblings and what they fight over', '6 min'],
  ['Your money card wants something different', '6 min'],
  ['Rich in suit, broke in rank', '5 min'],
  ['The 10 of Diamonds ceiling', '6 min'],
  ['Debt is a suit problem first', '6 min'],
  ['What Jupiter spends, Saturn collects', '7 min'],
  ['Your Saturn year, and its bill', '7 min'],
  ['The birthday everyone quietly dreads', '5 min'],
  ['Reading the year your Result card changes', '7 min'],
  ['Saturn return: the audit you scheduled', '8 min'],
  ['Your love card is not your marriage card', '6 min'],
  ['What two Hearts still argue about', '6 min'],
  ['The card you keep dating without meaning to', '7 min'],
  ['Compatibility is a suit conversation', '6 min'],
  ['Some pairings work on paper and nowhere else', '7 min'],
  ['Challenging karma, from inside the relationship', '8 min'],
  ['The card that left, and why', '6 min'],
  ['Grief has a suit too', '6 min'],
  ['A family chart, four people arguing', '8 min'],
  ['What your parents handed you first', '6 min'],
  ['The suit that works itself sick', '6 min'],
  ['Reading burnout before it has a name', '7 min'],
  ['Your job and your birth card rarely match', '6 min'],
  ['Court cards run the house, number cards do the chores', '6 min'],
  ['Same-suit King and Queen, still competing', '6 min'],
  ['The card that spends, the card that saves', '6 min'],
  ["Reading a child's card without predicting their life", '8 min'],
];
